...
ruleTester.run('required-attributes', requiredAttributes as never, {
  ...
  invalid: [
    // sp-theme missing all attributes
    {
    ...
    // overlay-trigger without triggered-by
    {
