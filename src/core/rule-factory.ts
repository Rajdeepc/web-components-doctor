  ...
  return {
    meta: {
      ...
      docs: {
        ...
        url: 'https://github.com/Rajdeepc/eslint-plugin-spectrum-wc#accessible-component',
      },
      messages: {
        missingOneOf:
  ...
  return {
    meta: {
      ...
      docs: {
        ...
        url: 'https://github.com/Rajdeepc/eslint-plugin-spectrum-wc#no-deprecated',
      },
      messages: {
  ...
  return {
    meta: {
      ...
      docs: {
        ...
        url: 'https://github.com/Rajdeepc/eslint-plugin-spectrum-wc#required-attributes',
      },
      messages: {
        missingRequired:
  ...
  return {
    meta: {
      ...
      docs: {
        ...
        url: 'https://github.com/Rajdeepc/eslint-plugin-spectrum-wc#valid-attribute-values',
      },
      messages: {
        invalidValue:
  ...
  return {
    meta: {
      ...
      docs: {
        ...
        url: 'https://github.com/Rajdeepc/eslint-plugin-spectrum-wc#valid-slot-names',
      },
      messages: {
        invalidSlot:
  ...
  return {
    meta: {
      ...
      docs: {
        ...
        url: 'https://github.com/Rajdeepc/eslint-plugin-spectrum-wc#valid-slot-children',
      },
      messages: {
        invalidChild:
