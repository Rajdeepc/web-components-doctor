      ...
      attributes: [
        {
          attribute: 'heading',
          message:
            'The "heading" property on <sp-illustrated-message> is deprecated. Use <h2 slot="heading"> instead.',
        },
        {
          attribute: 'description',
          message:
            'The "description" property on <sp-illustrated-message> is deprecated. Use <span slot="description"> instead.',
        },
      ],
    },
  },
